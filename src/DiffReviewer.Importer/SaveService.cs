...
{
    public class SaveServiceDelete// : ISaveService
    {
        private readonly ISaveRepository _saveRepository;
        public SaveServiceDelete(ISaveRepository saveRepository)
        {
        ...
        {
            return _saveRepository.SaveIndividualDiff(masterDiffId, diffContent, createdDate, originalFileName, modifiedFileName, isNewFile, 
        ...
        {
            return _saveRepository.SaveOriginalDiff(diffContent, pullRequestNumber, createdDate);
        }
        ...
        {
            return _saveRepository.SaveHunk(individualDiffId, originalRangeStartLine, originalRangeLinesAffected, newRangeStartLine,
        ...
        public int SaveSnippet(int hunkId, string snippetTypeName, DateTime createdDate)
        {
            ...
            return _saveRepository.SaveSnippet(hunkId, snippetTypeId, createdDate);
        }
        ...
        public int SaveLine(int hunkId, string value, string lineTypeName, string lineOriginName, DateTime createdDate)
        {
            ...
            return _saveRepository.SaveLine(hunkId, value, lineTypeId, lineOriginId, createdDate);
        }
        ...
        public int SaveLineSpan(int lineId, string value, string lineSpanTypeName, DateTime createdDate)
        {
            ...
            return _saveRepository.SaveLineSpan(lineId, value, lineSpanTypeId, createdDate);
        }
    }
}
